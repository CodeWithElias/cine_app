...
void main() {
  ...
  test(
    'una IP de red local vuelve a http con el backend en el 3333 y el agente en el 8000',
    () async {
  ...
  test(
    'el atajo «Nube (AWS)» del selector devuelve al valor por defecto',
    () async {
  ...
  test(
    'lo elegido en el selector se recuerda al volver a abrir la app',
    () async {
      await AppConfig.setHostIp('192.168.1.6');
