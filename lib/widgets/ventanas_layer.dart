            ...
            if (ticket != null) ...[
              Positioned.fill(
                child: GestureDetector(
                  onTap: () => ui.cerrar(TipoVentana.ticket),
...
class _Confirmacion extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final campos = ((datos['campos'] as List?) ?? const [])
        .whereType<Map>()
    ...
    if (imagen != null && imagen.startsWith('/')) {
      imagen =
          '$kVoiceAgentUrl$imagen'; // la portada la sirve el servicio de voz
    }
              ...
              children: [
                ...
                if (imagen != null || campos.isNotEmpty) ...[
                  ...
                  Row(
                    ...
                    children: [
                      if (imagen != null) ...[
                        Poster(url: imagen, width: 64, height: 96, radius: 10),
                      ...
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: LumenColors.surfaceContainerLowest
                ...
                if (aviso != null && aviso.isNotEmpty) ...[
                  ...
                  Container(
                    padding: const EdgeInsets.all(10),
                    decoration: BoxDecoration(
                      color: LumenColors.errorContainer.withValues(alpha: 0.3),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
...
class _Ticket extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final asientos = ((datos['asientos'] as List?) ?? const [])
        .map((a) => '$a')
        .toList();
