      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: LumenColors.primary.withValues(alpha: 0.12),
        ...
        LayoutBuilder(
          builder: (context, caja) => SizedBox(
            height: (caja.maxWidth * 0.62).clamp(190.0, 340.0),
            child: Listener(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, i) => AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    final pagina =
                        _pagina.hasClients && _pagina.position.haveDimensions
                        ? (_pagina.page ?? _actual.toDouble())
                        : _actual.toDouble();
        ...
        AnimatedSwitcher(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${actual.director} · ${actual.anio} · ${actual.genero}',
                style: const TextStyle(
